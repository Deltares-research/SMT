@echo off
set PATH=d:\current\dflowfm\;%PATH%
...
copy d:\current\dflowfm\unstruc.ini . 
copy d:\current\dflowfm\interact.ini .
copy d:\current\dflowfm\ISOCOLOUR.hls .
rem
rem start D-Flow FM
rem
%executable% --autostartstop --verbose:DEBUG:DEBUG %mdufile% > dflowfm.log
