...
# $Id: adaptsrc.py 20368 2026-02-20 08:01:32Z ottevan $ 
#
#===================================================================
# Import modules
#===================================================================
  ...
  for runid in RunIDs: 
    ...
    for i in range(len(lines)):
      ...
      if len(A)<2:
        ...
        keyword = A[0].lstrip()
        value   = A[1]
      if comparekeyword(keyword,'Tstart'):
        line = 'Tstart= %0.1f\n' % TStart
      elif comparekeyword(keyword,'Tstop'):
        line = 'Tstop = %0.1f\n' % TStop
      #elif keyword=='Tlfsmo':
      #  TLfsmo = 0.5*(TStop-TStart)
      #  line = 'Tlfsmo= %0.1f\n' % TLfsmo
      elif comparekeyword(keyword,'Dt'):
        Dt = eval(value)
      elif comparekeyword(keyword,'Flmap'):
        #
      ...
      elif comparekeyword(keyword,'Restid'):
        if RestartLevel<9:
          line = 'Restid= #'+restartfile+runid+'#\n'
        else: 
          line = str.replace(line,'DischQ',str(Disch))
      else:
        line = str.replace(line,'DischQ',str(Disch))
      if Disch==30:
